...
const MOOD_QUERIES = {
  unsettled: [
    'investigative documentary injustice',
    'exposé corruption power documentary',
    'uncomfortable truth documentary',
    'social justice civil rights documentary',
    'whistleblower investigative journalism',
    'climate crisis documentary',
    'inequality poverty documentary',
  ],
  moved: [
    'emotional human story short documentary',
    'moving portrait humanity film',
    'grief loss love documentary',
    'acts of kindness human connection',
    'personal story overcoming adversity',
    'tribute biography documentary',
    'StoryCorps human stories',
  ],
  transcendent: [
    'awe inspiring nature universe documentary',
    'space cosmos overview effect',
    'breathtaking nature time lapse',
    'philosophical meaning existence',
    'visual essay consciousness wonder',
    'deep ocean wildlife spectacular',
    'architecture art beauty visual',
  ],
  energized: [
    'incredible achievement triumph documentary',
    'athlete record breaking performance',
    'innovation breakthrough discovery',
    'against all odds comeback story',
    'passion craft mastery',
    'adventure extreme sport',
    'inspiring entrepreneurship success',
  ],
  ...
  settled: [
    ...
    'craft process satisfying documentary',
    'zen minimalism simplicity',
    'ocean forest rain relaxing',
    'traditional skills artisan craft',
    'japan korea culture daily life',
  ],
  contemplative: [
    'reflective essay film memory',
    'personal essay meaning life documentary',
    'nostalgia history retrospective',
    'poetic slow cinema essay',
    'identity belonging cultural',
...
const MOOD_KEYWORDS = {
  unsettled:             ['injustice','corruption','expose','truth','crisis','inequality','whistleblower','disturbing'],
  moved:                 ['emotional','moving','heartfelt','grief','love','kindness','human','story','tribute'],
  transcendent:          ['awe','breathtaking','universe','cosmos','wonder','beauty','stunning','vast','nature'],
  energized:             ['incredible','triumph','achievement','record','breakthrough','adventure','inspire','amazing'],
  intellectually_active: ['explained','science','philosophy','history','how','why','ideas','theory','research'],
  settled:               ['calming','peaceful','meditation','slow','relaxing','nature','craft','simple','gentle'],
  contemplative:         ['reflection','memory','nostalgia','meaning','identity','essay','personal','life','time'],
};
